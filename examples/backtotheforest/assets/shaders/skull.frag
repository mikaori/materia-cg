...
void main() {
  ...
  // calcula a iluminação da skull de acordo com a iluminação proveniente da lua
  ...
  // calcula a iluminação skull de acordo com a iluminação proveniente da skull
  ...
  vec4 color = colorSkull + colorMoon;
